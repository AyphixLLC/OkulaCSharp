    ...
    public class ShaderProgram {
        ...
        private void LoadShaderFromString(string code, ShaderType type) {
            if (type == ShaderType.VertexShader) {
                this.LoadShader(code, type, out VShaderID);
            } else if (type == ShaderType.FragmentShader) {
                this.LoadShader(code, type, out FShaderID);
            }
        }
        ...
        private void LoadShaderFromFile(string filename, ShaderType type) {
            using (StreamReader sr = new StreamReader(filename)) {
                if (type == ShaderType.VertexShader) {
                    this.LoadShader(sr.ReadToEnd(), type, out VShaderID);
                } else if (type == ShaderType.FragmentShader) {
                    this.LoadShader(sr.ReadToEnd(), type, out FShaderID);
                }
            }
        }
